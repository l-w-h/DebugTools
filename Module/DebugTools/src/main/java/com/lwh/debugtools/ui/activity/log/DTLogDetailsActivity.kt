package com.lwh.debugtools.ui.activity.log
...
import com.lwh.debugtools.ui.activity.log.presenter.LogDetailsPresenter
 ...
 * @description 日志详情页
 */
class DTLogDetailsActivity : RefreshActivity<BaseDiffCallBack>() {

    private val logDetailsPresenter = LogDetailsPresenter()
    ...
    companion object {
        ...
        fun startActivity(fragment: Fragment, id: Int) {
            val intent = Intent(fragment.context, DTLogDetailsActivity::class.java)
    ...
    override fun loadData(page: Int, pageSize: Int) {
        logDetailsPresenter.loadData(id, ::success)
    }
    ...
    override fun funcAClick(v: View) {
        ...
        val alertDialog: AlertDialog = AlertDialog.Builder(this)
            ...
            .setCancelable(false)
            .setPositiveButton("确定") { _, _ ->
                DatabaseUtils.deleteLogTableById(id)
