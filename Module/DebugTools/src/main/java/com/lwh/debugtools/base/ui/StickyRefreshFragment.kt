 ...
 * @description  吸顶+刷新Fragment 布局内需要refreshLayout和recyclerView
 */
abstract class StickyRefreshFragment<DiffCallBack : BaseDiffCallBack> : RefreshFragment<DiffCallBack>() {
