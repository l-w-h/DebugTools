package com.lwh.debugtools.ui.activity.request
...
import com.lwh.debugtools.ui.activity.request.presenter.RequestDetailsPresenter
 ...
 * @description 请求详情页
 */
class DTRequestDetailsActivity : RefreshActivity<BaseDiffCallBack>() {
    ...
    private val requestDetailsPresenter = RequestDetailsPresenter()
    ...
    companion object {
        ...
        fun startActivity(fragment: Fragment, id: Int) {
            val intent = Intent(fragment.context, DTRequestDetailsActivity::class.java)
    ...
    override fun loadData(page: Int, pageSize: Int) {
        requestDetailsPresenter.loadData(::success, id)
    }
    ...
    override fun funcAClick(v: View) {
        ...
        val alertDialog: AlertDialog = AlertDialog.Builder(this)
            ...
            .setCancelable(false)
            .setPositiveButton("确定") { _, _ ->
                DatabaseUtils.deleteRequestTableById(id)
